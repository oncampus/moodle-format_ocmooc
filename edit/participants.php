...
/**
 * Participants edit page for the OCMOOC course format.
 *
 * This file displays the participants edit page for the OCMOOC course format.
 * It includes the necessary code to render the participants edit page and handle
 * the course context.
 *
