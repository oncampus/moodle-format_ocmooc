...
/**
 * HTML page view for the OCMOOC course format.
 *
 * This file displays the HTML page view for the OCMOOC course format.
 * It includes the necessary code to render the HTML page view and handle
 * the course context.
 *
